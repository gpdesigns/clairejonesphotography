<section id="gallery">
	<div class="pnav">
		<ul>
			<li><a href="#" class="active"<?php echo site_url();?>portfolio">NATURE</a><span class="divider">|<span></li>
			...
			<li><a href="<?php echo site_url();?>Portrait">PORTRAITS</a><span class="divider">|<span></li>
